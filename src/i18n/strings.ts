...
const he = {
  ...
  homeRecentlyAddedHeading: 'נוספו לאחרונה',
  homeRecentlyAddedEmpty: 'עוד אין מפות בספרייה. אפשר לבקש אחת.',
  homeColTopic: 'נושא',
  homeColRef: 'מקור',
...
const en: Partial<Record<StringKey, string>> = {
  ...
  homeRecentlyAddedHeading: 'Recently added',
  homeRecentlyAddedEmpty: 'No maps in the library yet. You can request one.',
  homeColTopic: 'Topic',
